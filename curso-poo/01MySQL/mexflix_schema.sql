...
CREATE TABLE movieseries(
  ...
  FULLTEXT KEY search(title,gendre,author,actors),
...
/* 'Coming Soon','Released','In issue','Finished','Cancelled' */
...
INSERT INTO users (user,email,name,birthday,pass,role) VALUES
    ('@scipio','scipio@scipio.com','Escipión Emiliano','1987-05-14',MD5('fuchicaca'),'Admin'),
    ('@user','user@scipio.com','Usuario Mortal','2000-12-19',MD5('chimichangas'),'User');

/*http://omdbapi.com/*/
INSERT INTO movieseries (imdb_id, title, plot, gendre, author, actors, country, premiere, poster, trailer, rating, status, category) VALUES
