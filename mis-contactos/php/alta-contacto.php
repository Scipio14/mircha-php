...
<fieldset>
  ...
  <div>
    ...
    <input type="date" id="nacimiento" class="cambio" name="nacimiento_txt" placeholder="Escribe tu cumpleaños" required>
  </div>
  <div>
    <label for="telefono">Teléfono: </label>
    <input type="text" id="telefono" class="cambio" name="telefono_txt" placeholder="Escribe tu teléfono" title="Tu teléfono" required>
  </div>
  <div>
  ...
  <div>
    ...
    <input type="file" id="fot" name="foto_fls" title="Sube tu foto">
  </div>
  <div>
